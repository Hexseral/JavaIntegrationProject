 ...
 */
/**This is the class for all the data types in Java.
 * @author Jordan Tatum
 *
 */
class JavaVariables {
  ...
  /** Prints all sample data types when called.
   * 
   */
  public void variablesPrint() {
    ...
    System.out.println("An example of a final int Stored Within This Program: " + CONST);
  }
}
